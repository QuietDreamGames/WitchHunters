...
using Packages.OSSC.Scripts.Core.Model;
using UnityEngine;
    ...
    public class SoundController : MonoBehaviour
    {
        ...
        public ISoundCue Play(PlaySoundSettings settings)
        {
            ...
            if (parent != null)
            {
                ...
                cue.AudioObject.transform.localPosition = Vector3.zero;
            }
            else
            {
                cue.AudioObject.transform.position = settings.worldPosition;
            }
        ...
        private SoundCueProxy PlaySoundCue(PlaySoundSettings settings)
        {
            ...
            if (parent != null)
            {
                ...
                ncue.AudioObject.transform.localPosition = Vector3.zero;
            }
            else
            {
                ncue.AudioObject.transform.position = settings.worldPosition;
            }
